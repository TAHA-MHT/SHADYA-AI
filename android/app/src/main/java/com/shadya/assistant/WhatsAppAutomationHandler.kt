...
class WhatsAppAutomationHandler(private val service: AccessibilityService) {
    ...
    fun handleAccessibilityEvent(event: AccessibilityEvent) {
        ...
        // 5octies. Écran "Add a business description" — champ optionnel de
        // description (0/512 caractères). "Next" grisé sans texte. On
        // clique sur "Skip" (en haut à droite) pour passer cette étape,
        // comme pour l'adresse et la photo de profil.
