...
class WhatsAppAutomationHandler(private val service: AccessibilityService) {
    ...
    fun handleAccessibilityEvent(event: AccessibilityEvent) {
        ...
        // 5septies. Écran "More ways to find you" — demande une adresse ou
        // un site web (tous deux optionnels, "Next" grisé sans remplissage,
        // pas de bouton "Continue" simple). On clique sur "Skip" (en haut à
        // droite) pour passer cette étape, comme pour la photo de profil.
